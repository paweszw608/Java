...
public class WorldCupStatsServlet extends HttpServlet {
     ...
     * Model reference
     */
    private WorldCupStatsModel theModel;

    /**
     * Helps to control switching between views equivalents 0 - Infilling Groups
     * 1 - Setting Results 2 - Reviewing Standings
     */
     ...
     * @throws IOException if wrong redirect string
     */
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        for (Cookie cookie : cookies) {
            ...
            } else if (cookie.getName().equals("isLogged")) {
                isLogged = cookie.getValue();
            }
        }
        ...
        try (PrintWriter out = response.getWriter()) {
                        ...
                        case "Add team":
                            ...
                            if (teamName != null) {
                                try {
                                    ...
                                    // saving operation to history table
                                    try {
                                    ...
                                    try (Connection con = DriverManager.getConnection("jdbc:derby://localhost:1527/WorldCupStatsDatabase", this.getInitParameter("user"), this.getInitParameter("password"))) {
                                        ...
                                        String query = "INSERT INTO history(operation, comment) VALUES ('Adding team', 'Team " + teamName + " added to group " + theModel.getGroupName() + "')";
                    ...
                    switch (btnId) {
                        case "Confirm results": {
                            ...
                            try {
                                ...
                                try (Connection con = DriverManager.getConnection("jdbc:derby://localhost:1527/WorldCupStatsDatabase", this.getInitParameter("user"), this.getInitParameter("password"))) {
                                    java.sql.Statement statement = con.createStatement();
                                    String query = "INSERT INTO history(operation, comment) VALUES ('Confirming results', 'Results of group " + theModel.getGroupName() + " confrimed succeesfuly'" + ")";
                                    statement.executeUpdate(query);
                                } catch (SQLException ex) {
                                    System.err.println(ex.getMessage());
                                }
            ...
            out.println("<p></p><input type=\"submit\" value=\"Logout\" name=\"loggedout\"/><p></p>");
            out.println("</form>");
